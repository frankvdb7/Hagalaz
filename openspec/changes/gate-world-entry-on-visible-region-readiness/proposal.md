...
- Treat any region-load failure as a terminal world-entry failure: abort the
  session and let the existing disconnect/sign-out owner perform cleanup; do
  not retry within the entry operation.
