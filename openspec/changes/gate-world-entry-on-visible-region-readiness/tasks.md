...
- [x] 1.2 Add an internal all-visible-regions wait operation that treats only `State == Ready` as success and reports loader/readiness failures without retrying.
- [x] 1.3 Add deterministic scheduler tests for waiting on every region, already-ready suppression, and failure completion.
