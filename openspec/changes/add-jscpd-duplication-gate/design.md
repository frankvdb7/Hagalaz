...
- The local SARIF report is version 2.1.0 and gives all 559 results a primary location, related location, and fingerprint. `actionlint` validates the workflow. Hosted Code Scanning upload remains to be checked in the pull-request run.
