...
- [x] 2.5 Register map/appearance resynchronization as post-commit work and preserve response-first replacement output ordering; terminate invalidated temporary replacements.
