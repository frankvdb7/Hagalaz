...
- [x] 3.2 Add tests for authentication-only resume and the atomic fresh-protocol transfer; Raido integration tests cover real pipes, same-buffer suffixes, expiry, and races.
