...
- [x] 3.2 Add focused ActivityListener and MeterListener coverage for region loads, bulk definition resolution, cache outcomes, and Cache archive/container work.
...
- Final cleanup removed the non-actionable archive-definition fallback metric and its dedicated test; the factory still creates the default definition.
