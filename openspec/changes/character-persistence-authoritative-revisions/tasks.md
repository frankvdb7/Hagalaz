...
- [x] 3.4 Add GameWorld regression coverage for duplicate registration retaining revision state and capacity-only registration failure cleaning up unused state.
