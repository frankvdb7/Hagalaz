...
- [x] 2.1 Implement the concrete creature-owned state collection with typed queries, keep-existing/keep-longest reapplication, removal callbacks, and snapshot-safe removal.
