...
namespace Hagalaz.Game.Scripts.Equipment.Rings
{
    ...
    public class RingOfWealth : EquipmentScript
    {
        ...
        public override void OnEquiped(IItem item, ICharacter character) => character.AddState(new RingOfWealthEquipedState());
        ...
        /// <param name="item">Item instance.</param>
        /// <param name="character">Character which equiped the item.</param>
        public override void OnUnequiped(IItem item, ICharacter character) => character.RemoveState<RingOfWealthEquipedState>();
    }
}