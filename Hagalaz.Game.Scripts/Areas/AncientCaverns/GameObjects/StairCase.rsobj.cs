...
namespace Hagalaz.Game.Scripts.Areas.AncientCaverns.GameObjects
{
    ...
    public class StairCase : GameObjectScript
    {
            ...
            if (clickType == GameObjectClickType.Option1Click)
            {
                ...
                if (Owner.Definition.HasAction("Climb-down"))
                {
                    ...
                    clicker.QueueTask(new RsTask(() =>
                        {
                            clicker.Movement.Teleport(Teleport.Create(Location.Create(clicker.Location.X, (short)(clicker.Location.Y + 3), (byte)(clicker.Location.Z - 1), clicker.Location.Dimension)));
        ...
        /// </summary>
        /// <returns></returns>
        public override int[] GetSuitableObjects() => [25339, 25340];
