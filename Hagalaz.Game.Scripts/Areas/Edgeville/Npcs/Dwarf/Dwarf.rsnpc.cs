...
namespace Hagalaz.Game.Scripts.Areas.Edgeville.Npcs.Dwarf
{
    [NpcScriptMetaData([3295])]
    public class Dwarf : NpcScriptBase
    {
        /// <summary>
        ...
        public override void OnCharacterClickPerform(ICharacter clicker, NpcClickType clickType)
        {
            ...
            {
                clicker.Widgets.OpenDialogue(new SkillCapeDialogue.SkillCapeDialogue(clicker.ServiceProvider.GetRequiredService<ICharacterContextAccessor>(), StatisticsConstants.Mining), true, Owner);
            }
            else
            {
