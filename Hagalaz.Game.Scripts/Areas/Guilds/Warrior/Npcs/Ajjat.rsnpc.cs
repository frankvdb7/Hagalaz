...
{
    [NpcScriptMetaData([4288])]
    public class Ajjat : NpcScriptBase
    {
        public Ajjat(INpc owner, INpcService npcService, ISimplePathFinder pathFinder, IWidgetScriptActivator widgetScriptActivator)
