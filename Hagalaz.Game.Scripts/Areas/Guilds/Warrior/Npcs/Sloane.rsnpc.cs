...
namespace Hagalaz.Game.Scripts.Areas.Guilds.Warrior.Npcs
{
    [NpcScriptMetaData([4297])]
    public class Sloane : NpcScriptBase
    {
        public Sloane(INpc owner, INpcService npcService, ISimplePathFinder pathFinder, IWidgetScriptActivator widgetScriptActivator)
        ...
        public override void OnCharacterClickPerform(ICharacter clicker, NpcClickType clickType)
        {
            if (clickType == NpcClickType.Option1Click)
            {
                ...
                skillCapeDialogue.SkillID = StatisticsConstants.Strength;
