...
{
    /// <summary>
    ///     Forinthry dungeon entrances.
    /// </summary>
    public class FdCaveEntrance : GameObjectScript
    {
        /// <summary>
        ...
        public override void OnCharacterClickPerform(ICharacter clicker, GameObjectClickType clickType)
        {
            if (clickType == GameObjectClickType.Option1Click)
            {
                ...
                clicker.QueueTask(new RsTask(() =>
                    {
                        clicker.Movement.Teleport(Owner.Id == 20600 ? Teleport.Create(Location.Create(3077, 10058, 0, 0)) : Teleport.Create(Location.Create(3037, 10171, 0, 0)));
        ...
        /// </summary>
        /// <returns></returns>
        public override int[] GetSuitableObjects() => [20599, 20600];
