...
namespace Hagalaz.Game.Scripts.Areas.SlayerTower.GameObjects
{
    /// <summary>
    /// </summary>
    public class StaircaseSecondFloor : GameObjectScript
    {
        /// <summary>
            ...
            if (clickType == GameObjectClickType.Option1Click)
            {
                ...
                if (Owner.Definition.HasAction("Climb-down"))
                {
                    ...
                    clicker.QueueTask(new RsTask(() =>
                        {
                            clicker.Movement.Teleport(Teleport.Create(Location.Create((short)(clicker.Location.X - 5), clicker.Location.Y, (byte)(clicker.Location.Z - 1), clicker.Location.Dimension)));
        ...
        /// </summary>
        /// <returns></returns>
        public override int[] GetSuitableObjects() => [4495, 4496];
