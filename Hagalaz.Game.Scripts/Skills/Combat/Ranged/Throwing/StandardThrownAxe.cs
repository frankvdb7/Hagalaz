...
namespace Hagalaz.Game.Scripts.Skills.Combat.Ranged.Throwing
{
    /// <summary>
    /// </summary>
    [EquipmentScriptMetaData([800, 801, 802, 803, 804, 805])]
    public class StandardThrownAxe : EquipmentScript
    {
        private readonly IThrowingLogicService _throwingLogicService;

        public StandardThrownAxe(IThrowingLogicService throwingLogicService) => _throwingLogicService = throwingLogicService;
