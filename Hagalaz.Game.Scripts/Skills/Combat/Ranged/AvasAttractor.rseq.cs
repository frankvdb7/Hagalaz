...
namespace Hagalaz.Game.Scripts.Skills.Combat.Ranged
{
    ...
    public class AvasAttractor : EquipmentScript
    {
        ...
        public override void OnEquiped(IItem item, ICharacter character) => character.AddState(new AvasAttractorEquipedState());
        ...
        /// <param name="item">Item instance.</param>
        /// <param name="character">Character which equiped the item.</param>
        public override void OnUnequiped(IItem item, ICharacter character) => character.RemoveState<AvasAttractorEquipedState>();
    }
}