...
{
    /// <summary>
    ///     Contains bones script.
    /// </summary>
    public class StandardBones : ItemScript
    {
        ...
        /// <returns></returns>
        public override bool UseItemOnGameObject(IItem used, IGameObject usedOn, ICharacter character) => usedOn.Id == 13197 && Prayer.UseOnAltar(character, used, usedOn, _prayerService);
        ...
        private static void OnRemovedCallBack(ICharacter character, IItem toRemove, PrayerDto definition, int slot)
        {
            ...
            character.SendChatMessage("You bury the bones.");
