...
namespace Hagalaz.Game.Scripts.Dialogues
{
    ...
    public class SellStolenGoodsDialogue : NpcDialogueScript
    {
        ...
        public SellStolenGoodsDialogue(ICharacterContextAccessor characterContextAccessor, IRatesService ratesService, IItemBuilder itemBuilder) :
        ...
        public override void OnOpen()
        {
            ...
            AttachDialogueOptionClickHandler("Yes, please!",
                (extraData1, extraData2) =>
                {
                    ...
                    StandardNpcDialogue(TalkingTo,
                        ...
                        "There you go!",
                        "Now on your way, " + Owner.DisplayName + "!",
            ...
            AttachDialogueOptionClickHandler("No, thanks!",
                (extraData1, extraData2) =>
                {
                    Owner.Widgets.CloseChatboxOverlay();
                    return false;
