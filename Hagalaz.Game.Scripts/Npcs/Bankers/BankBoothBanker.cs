...
{
    [NpcScriptMetaData([166, 553, 2759])]
    public class BankBoothBanker : NpcScriptBase
    {
        public BankBoothBanker(INpc owner, INpcService npcService, ISimplePathFinder pathFinder, IWidgetScriptActivator widgetScriptActivator)
