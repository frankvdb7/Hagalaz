...
namespace Hagalaz.Game.Scripts.Npcs.Shops
{
    ...
    {
        public ClothesStore(INpc owner, INpcService npcService, ISimplePathFinder pathFinder, IWidgetScriptActivator widgetScriptActivator)
        ...
        public override void OnCharacterClickPerform(ICharacter clicker, NpcClickType clickType)
        {
            ...
            {
                clicker.EventManager.SendEvent(new OpenShopEvent(clicker, 9));
                return;
            }
