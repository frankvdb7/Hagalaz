...
namespace Hagalaz.Game.Scripts.Npcs.Shops
{
    /// <summary>
    /// </summary>
    [NpcScriptMetaData([545])]
    public class CraftingStore : NpcScriptBase
    {
        public CraftingStore(INpc owner, INpcService npcService, ISimplePathFinder pathFinder, IWidgetScriptActivator widgetScriptActivator)
        ...
        public override void OnCharacterClickPerform(ICharacter clicker, NpcClickType clickType)
        {
            ...
            {
                clicker.EventManager.SendEvent(new OpenShopEvent(clicker, 13));
                return;
            }
