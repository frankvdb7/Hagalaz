...
namespace Hagalaz.Game.Scripts.Minigames.Soulwars.GameObjects
{
    /// <summary>
    /// </summary>
    public class ExitPortal : GameObjectScript
    {
        /// <summary>
        ...
        public override void OnCharacterClickPerform(ICharacter clicker, GameObjectClickType clickType)
        {
            if (clickType == GameObjectClickType.Option1Click)
            {
                ...
                clicker.QueueTask(new RsTask(() =>
                    {
                        clicker.Movement.Teleport(Teleport.Create(Location.Create(3082, 3474, 0)));
        ...
        /// </summary>
        /// <returns></returns>
        public override int[] GetSuitableObjects() => [42220];
