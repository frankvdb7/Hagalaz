...
namespace Hagalaz.Game.Scripts.Minigames.TzHaar.Cave.GameObjects
{
    /// <summary>
    /// </summary>
    public class CaveEntrance : GameObjectScript
    {
        /// <summary>
        ...
        public override void OnCharacterClickPerform(ICharacter clicker, GameObjectClickType clickType)
        {
            if (clickType == GameObjectClickType.Option1Click)
            {
                ...
                clicker.QueueTask(new RsTask(() =>
                    {
                        clicker.Movement.Teleport(Teleport.Create(Location.Create(4461, 5181, 0, 0)));
        ...
        /// </summary>
        /// <returns></returns>
        public override int[] GetSuitableObjects() => [9356];
