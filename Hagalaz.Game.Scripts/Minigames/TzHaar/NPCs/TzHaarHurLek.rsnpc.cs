...
{
    [NpcScriptMetaData([2622])]
    public class TzHaarHurLek : NpcScriptBase
    {
        public TzHaarHurLek(INpc owner, INpcService npcService, ISimplePathFinder pathFinder, IWidgetScriptActivator widgetScriptActivator)
        ...
        public override void OnCharacterClickPerform(ICharacter clicker, NpcClickType clickType)
        {
            ...
            {
                clicker.EventManager.SendEvent(new OpenShopEvent(clicker, 18));
                return;
            }
