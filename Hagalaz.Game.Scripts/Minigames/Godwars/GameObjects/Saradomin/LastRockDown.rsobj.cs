...
namespace Hagalaz.Game.Scripts.Minigames.Godwars.GameObjects.Saradomin
{
    /// <summary>
    /// </summary>
    [GameObjectScriptMetaData([26445])]
    public class LastRockDown : GameObjectScript
    {
        private readonly IItemBuilder _itemBuilder;

        public LastRockDown(IItemBuilder itemBuilder)
        {
        ...
        public override void OnCharacterClickPerform(ICharacter clicker, GameObjectClickType clickType)
        {
            switch (clickType)
            {
                ...
                case GameObjectClickType.Option2Click when clicker.HasState<HasSaradominLastRockRopeState>():
