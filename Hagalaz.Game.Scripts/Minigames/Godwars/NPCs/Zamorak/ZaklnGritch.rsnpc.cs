...
namespace Hagalaz.Game.Scripts.Minigames.Godwars.NPCs.Zamorak
{
    ...
    public class ZaklnGritch : BodyGuard
    {
        ...
        public ZaklnGritch(INpc owner, IProjectileBuilder projectileBuilder, INpcService npcService, ISimplePathFinder pathFinder, IWidgetScriptActivator widgetScriptActivator)
