...
namespace Hagalaz.Game.Scripts.Minigames.Godwars.NPCs.Saradomin
{
    ...
    public class Growler : BodyGuard
    {
        ...
        public Growler(INpc owner, IProjectileBuilder projectileBuilder, INpcService npcService, ISimplePathFinder pathFinder, IWidgetScriptActivator widgetScriptActivator)
        ...
        {
            RenderAttack();
            //this.owner.QueueGraphic(Graphic.Create(1184));
