...
namespace Hagalaz.Game.Scripts.Minigames.Godwars.NPCs.Bandos
{
    /// <summary>
    /// </summary>
    [NpcScriptMetaData([6276])]
    public class SpiritualRanger : BandosFaction
    {
        public SpiritualRanger(INpc owner, INpcService npcService, ISimplePathFinder pathFinder, IWidgetScriptActivator widgetScriptActivator)
