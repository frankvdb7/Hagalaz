...
namespace Hagalaz.Game.Scripts.Minigames.Godwars.NPCs.Armadyl
{
    ...
    public class WingmanSkree : BodyGuard
    {
        ...
        public WingmanSkree(INpc owner, IProjectileBuilder projectileBuilder, INpcService npcService, ISimplePathFinder pathFinder, IWidgetScriptActivator widgetScriptActivator)
        ...
        public override bool CanBeAttackedBy(ICreature attacker)
        {
            ...
            {
                Owner.QueueTask(new RsTask(() => Owner.Combat.SetTarget(attacker.Handle), 1));
            }
