...
namespace Hagalaz.Services.GameWorld.Model.Creatures.Characters
{
    ...
    public class CharacterStatistics : ICharacterStatistics, IHydratable<HydratedStatisticsDto>, IDehydratable<HydratedStatisticsDto>
    {
        ...
        private static int[] EnsureLength(int[] values, int length, int defaultValue)
        {
        ...
        private static double[] EnsureLength(double[] values, int length, double defaultValue)
        {
            if (values.Length == length)
            {
                return values;
        ...
        private static bool[] EnsureLength(bool[] values, int length, bool defaultValue)
        {
            if (values.Length == length)
            {
                return values;
