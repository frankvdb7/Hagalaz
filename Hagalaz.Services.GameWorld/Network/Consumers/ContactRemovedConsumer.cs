...
{
    public class ContactRemovedConsumer : IConsumer<ContactRemovedMessage>
    {
        private readonly IGameConnectionService _connectionService;
        private readonly IMapper _mapper;

        public ContactRemovedConsumer(IGameConnectionService connectionService, IMapper mapper)
        {
            _connectionService = connectionService;
            _mapper = mapper;
        }

        public async Task Consume(ConsumeContext<ContactRemovedMessage> context)
        {
            ...
            masterFriend.AreMutualFriends = false;
