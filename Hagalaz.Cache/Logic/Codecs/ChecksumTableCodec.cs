...
namespace Hagalaz.Cache.Logic.Codecs
{
    ...
    public class ChecksumTableCodec : IChecksumTableCodec
    {
        ...
        public MemoryStream Encode(IChecksumTable table) => Encode(table, false);
        ...
        /// <returns>A memory stream containing the encoded checksum table.</returns>
        public MemoryStream Encode(IChecksumTable table, bool whirlpool) => Encode(table, whirlpool, BigInteger.MinusOne, BigInteger.MinusOne);
        ...
        public MemoryStream Encode(IChecksumTable table, bool whirlpool, BigInteger modulus, BigInteger privateKey)
        {
        ...
        public IChecksumTable Decode(MemoryStream stream) => Decode(stream, false);

        public IChecksumTable Decode(MemoryStream stream, bool whirlpool) => Decode(stream, whirlpool, BigInteger.MinusOne, BigInteger.MinusOne);

        public IChecksumTable Decode(MemoryStream stream, bool whirlpool, BigInteger modulus, BigInteger publicKey)
        {
