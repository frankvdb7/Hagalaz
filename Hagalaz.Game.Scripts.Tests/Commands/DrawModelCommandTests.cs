...
{
    [TestClass]
    public class DrawModelCommandTests
    {
        [TestMethod]
        public async Task Execute_WithValidArguments_DrawsModel()
        {
            // Arrange
            ...
            var command = new DrawModelCommand();
            ...
            // Assert
            widgetMock.Received(1).DrawModel(2, 3);
        }
    }
}
