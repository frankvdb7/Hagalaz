...
namespace Hagalaz.Game.Abstractions.Factories
{
    ...
    public interface IStateScriptFactory
    {
        ...
        /// </summary>
        /// <returns>An <see cref="IAsyncEnumerable{T}"/> of tuples, where each tuple contains a <see cref="StateType"/> and the <see cref="Type"/> of the <see cref="IStateScript"/> that handles it.</returns>
