...
{
    /// <summary>
    /// Represents a discrete 64x64 area of the game world.
    /// </summary>
    public interface IMapRegion
    {
        ...
        /// <summary>
        /// Gets the XTEA (eXtended Tiny Encryption Algorithm) keys used to decrypt this map region's data.
        /// </summary>
        int[] XteaKeys { get; }
        ...
        /// <summary>
        /// Iterates over all characters in the region using a state-based callback to avoid allocations.
        /// </summary>
        ...
        /// <summary>
        /// Iterates over all NPCs in the region using a state-based callback to avoid allocations.
        /// </summary>
        /// <typeparam name="TState">The type of the state object.</typeparam>
        /// <param name="action">The action to perform on each NPC.</param>
        /// <param name="state">The state object to pass to the action.</param>
