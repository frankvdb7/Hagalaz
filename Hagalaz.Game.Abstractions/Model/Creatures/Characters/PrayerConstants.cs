...
{
    /// <summary>
    /// Provides constant values related to the Prayer skill, including level requirements, drain rates, and activation/deactivation rules.
    /// </summary>
    public static class PrayerConstants
    {
        /// <summary>
        /// An array mapping prayer button IDs to their corresponding <see cref="NormalPrayer"/> enum index.
        /// </summary>
        ...
        /// <summary>
        /// An array of Prayer level requirements for each standard prayer.
        /// </summary>
        ...
        /// <summary>
        /// An array of drain rates for each standard prayer, in milliseconds per prayer point.
        /// </summary>
        ...
        /// <summary>
        /// A two-dimensional array defining which standard prayers are deactivated when another is activated.
        /// </summary>
        ...
        /// <summary>
        /// An array of Prayer level requirements for each ancient curse.
        /// </summary>
        ...
        /// <summary>
        /// An array of drain rates for each ancient curse, in milliseconds per prayer point.
        /// </summary>
        ...
        /// <summary>
        /// An array containing all <see cref="NormalPrayer"/> enum members in order.
        /// </summary>
        ...
        /// <summary>
        /// An array containing all <see cref="AncientCurses"/> enum members in order.
        /// </summary>
