...
namespace Raido.Server
{
    ...
    public interface IRaidoConnectionContextBuilderOptional : IRaidoConnectionContextBuilderBuild
    {
        ...
        /// <summary>
        /// Enables same-process stateful reconnect for the context.
        /// </summary>
        /// <param name="gracePeriod">An optional bounded replacement-transport grace period.</param>
        /// <returns>The builder instance.</returns>
        IRaidoConnectionContextBuilderOptional WithStatefulReconnect(TimeSpan? gracePeriod = null);
    }
