...
namespace Hagalaz.AppHost.Telemetry
{
    ...
    {
        private const string _dashboardOtlpUrlVariableName = "DOTNET_DASHBOARD_OTLP_ENDPOINT_URL";
        private const string _dashboardOtlpApiKeyVariableName = "AppHost:OtlpApiKey";
        private const string _dashboardOtlpUrlDefaultValue = "http://localhost:18889";
            ...
            this IDistributedApplicationBuilder builder, string name, string configFileLocation)
        {
            ...
            var url = builder.Configuration[_dashboardOtlpUrlVariableName] ?? _dashboardOtlpUrlDefaultValue;
            ...
            var resourceBuilder = builder.AddResource(resource)
                ...
                .WithEnvironment("ASPIRE_API_KEY", builder.Configuration[_dashboardOtlpApiKeyVariableName])
            ...
            if (isHttpsEnabled && builder.ExecutionContext.IsRunMode && builder.Environment.IsDevelopment())
            {
                resourceBuilder.RunWithHttpsDevCertificate("HTTPS_CERT_FILE",
                    ...
                    (certFilePath, certKeyPath) =>
                    {
                        ...
                        resourceBuilder.WithArgs(@"--config=yaml:receivers::otlp::protocols::grpc::tls::cert_file: ""dev-certs/dev-cert.pem""",
