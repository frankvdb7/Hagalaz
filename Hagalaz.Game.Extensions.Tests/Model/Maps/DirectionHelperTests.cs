...
namespace Hagalaz.Game.Extensions.Tests.Model.Maps
{
    [TestClass]
    public class DirectionHelperTests
    {
        [DataTestMethod]
        [DataRow(0, 1, 0)] // North
        [DataRow(1, 1, 1)] // North-East
        [DataRow(1, 0, 2)] // East
        [DataRow(1, -1, 3)] // South-East
        [DataRow(0, -1, 4)] // South
        [DataRow(-1, -1, 5)] // South-West
        [DataRow(-1, 0, 6)] // West
        [DataRow(-1, 1, 7)] // North-West
        ...
        [DataRow(8, DirectionFlag.None)] // Invalid
        ...
        [DataRow(10, 10, 10, 10, DirectionFlag.None)] // Same location
